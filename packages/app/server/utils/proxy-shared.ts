 ...
 * the pod's preview server (ECONNREFUSED / timeout). Refreshes every 3 seconds
 * so the preview loads automatically once the server starts.
 */
...
</head><body><div class="c"><div class="s"></div><h1>Preparing preview</h1><p>This page will refresh automatically.</p></div></body></html>`;
}
